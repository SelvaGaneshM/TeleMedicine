...
public class CustomAlertController {
   ...
   public class func showAlert(message : String, okAction:@escaping () -> Void){
    ...
    CustomAlertController.instance.topMostController()?.present(alert, animated: true, completion: nil)
    }
    ...
    {
       _ = alert(title : title, message: message, acceptMessage: "Ok") { () -> () in
            // Do nothing
        }
    }
